package com.cecar.smartbookmobile.features.sales
...
import com.cecar.smartbookmobile.core.model.SaleItemRequest
...
private fun SaleFormDialog(
    ...
    val total = items.sumOf { item ->
        val price = books.firstOrNull { it.id == item.bookId }?.valorVentaPulico ?: 0.0
    ...
    Card(
        ...
        Column(
            ...
            items.forEach { item ->
                ...
                val unitPrice = selectedBook?.valorVentaPulico ?: 0.0
                val quantity = item.quantity.toIntOrNull() ?: 0
